...
- Select a villager to place any building, a town center to train villagers, a barracks to train militia/spearmen, an archery range to train archers, a stable to train scout cavalry, or a market to train trade carts. Destroy the enemy town center to win.
