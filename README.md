...
- Sheep join whoever walks up to them and then stand where they are: select them
  and walk them home like any other unit. A villager sent onto one turns it into food. Deer run, and a boar charges whoever wounds it — send more than one villager. Click a carcass to see how much food is left on it.
