...
| Shore foam tempo and phase | 16 frames a second through the 128, each tile's phase from the match seed, the mirrored pair by a coin | chosen | `foam.ts` `FRAME_RATE` | #89 |
